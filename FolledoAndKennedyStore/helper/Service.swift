...
class Service { //FB ep.29 1mins
	...
	static func isValidEmail(email: String) -> Bool { //FB ep.29 2mins validate email
		/*
		1) declare a rule
		...
		*/
		...
		let test = NSPredicate(format: "SELF MATCHES %@", reg) //FB ep.29 6mins we want it to be matching with out regex rules
	...
	static func isValidName(name: String) -> Bool { //FB ep.29 8mins
